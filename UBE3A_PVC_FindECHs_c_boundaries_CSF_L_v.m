function [boundaries,ind]=UBE3A_PVC_FindECHs_c_boundaries_CSF_L_v(c3,suvr,aparc,ind_FS)
...
% left lateral ventricle (4,5) and left choroid plexus (31)
ind_v = (raparc == 4) |  (raparc == 5) | (raparc == 31);
