function [ECH,stat]=UBE3A_PVC_FindECHs_c_CSF_not_v(c3,suvr,aparc,resol,ind_FS)
...
%% I find boundaries
[boundaries,ind]=UBE3A_PVC_FindECHs_c_boundaries_CSF_not_v(c3,suvr,aparc,resol,ind_FS);
